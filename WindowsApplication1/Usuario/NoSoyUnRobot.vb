...
Public Class NoSoyUnRobot
    Private Sub NoSoyUnRobot_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        Dim texto As String
        mensajeLbl.Text = ""
    ...
    Private Sub NoSoyUnRobot_VisibleChanged(sender As Object, e As EventArgs) Handles MyBase.VisibleChanged
        If Me.Visible Then
            Dim texto As String
            mensajeLbl.Text = ""
            If Dir("./respuesta.txt") <> "" Then
    ...
    Private Sub NoSoyUnRobot_FormClosing(sender As Object, e As FormClosingEventArgs) Handles MyBase.FormClosing
        If Dir("./usuario.txt") <> "" Then
