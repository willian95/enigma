...
Public Class coordenadas
    Private Sub coordenadas_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        Console.WriteLine("numero original " + params(5).Value.ToString)
    ...
    Private Sub Button1_Click(sender As Object, e As EventArgs) Handles Button1.Click
        ...
        Console.WriteLine("valor mensaje " + userResponse)
        Console.WriteLine("codificar mensaje " + params(3).Value.ToString)
    ...
    Private Sub coordenadas_FormClosing(sender As Object, e As FormClosingEventArgs) Handles MyBase.FormClosing
        If Dir("./usuario.txt") <> "" Then
    ...
    Private Sub coordenadas_VisibleChanged(sender As Object, e As EventArgs) Handles MyBase.VisibleChanged
        Dim conexion As String
        Dim conexionTxt As String
        Dim texto As String
        Dim Pos As String
